...
const NetlifyLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 40 40" className={classNames('w-5 h-5', className)}>
    <path
      fill="currentColor"
...
export default function NetlifyConnection() {
  ...
  console.log('NetlifyConnection initial state:', {
    ...
    serverAutoConnect: '[DISABLED_IN_CLIENT]',
  });
  ...
  return (
    <div className="space-y-6 bg-bolt-elements-background dark:bg-bolt-elements-background border border-bolt-elements-borderColor dark:border-bolt-elements-borderColor rounded-lg">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <NetlifyLogo className={providerBranding.netlify.iconClassName} />
            ...
            <div className="flex gap-2 mt-4">
              <button
                ...
                className={classNames(
                  ...
                  providerBranding.netlify.connectButtonClassName,
